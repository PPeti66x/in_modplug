...
/************************************************************************
*                                                                       *
*   commonfix.h v 3.01-- This module is supported Windows 95/98/Me/2000 *
...
int _declspec(naked ) WINAPI _imp__InterlockedCompareExchange(DWORD flg1,DWORD flg2,DWORD flg3)
{
	_asm{
		_emit 0x60
		_emit 0x90
...
int _declspec(naked ) WINAPI _imp__GetModuleHandleEx()
{
	_asm{
		_emit 0x33
		_emit 0xc0
